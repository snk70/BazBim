...
Sub SetSize_check(View As CheckBox,tv As Float,lv As Float,hv As Float,wv As Float,FontSize As Float)
sizemode(View,tv,lv,hv,wv,WidthAct,HeightAct)
View.TextSize=fsz(View.Width,View.Height,GetPastWidth(View.Width),GetPastHeight(View.Height),FontSize)
End Sub
...
Sub SetSize_listview(View As ListView,tv As Float,lv As Float,hv As Float,wv As Float,FontSize As Float)
sizemode(View,tv,lv,hv,wv,WidthAct,HeightAct)
End Sub
