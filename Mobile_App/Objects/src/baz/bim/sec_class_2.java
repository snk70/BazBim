...
public class sec_class_2 extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "baz.bim.sec_class_2");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", baz.bim.sec_class_2.class).invoke(this, new Object[] {null});
        else
...
{
final int step6 = 1;
final int limit6 = (int) (_t.length()/(double)_vvv4-1);
...
_x = _txt.substring((int) (_txt.length()-_vvv4));
...
_txt = _txt.substring((int) (0),(int) (_txt.length()-_vvv4));
 }
};
...
public String  _vvv2(String _val) throws Exception{
...
public String  _vvv3(String _val) throws Exception{
anywheresoftware.b4a.agraham.encryption.Base64 _bs = null;
