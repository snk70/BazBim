...
float _n1 = 0f;
float _n2 = 0f;
 //BA.debugLineNum = 73;BA.debugLine="Private Sub fsz(wdh As Float,hgh As Float,szw As F";
 //BA.debugLineNum = 74;BA.debugLine="Dim fs1,fs2,fs3 As Float";
_fs1 = 0f;
_fs2 = 0f;
_fs3 = 0f;
 //BA.debugLineNum = 75;BA.debugLine="Dim n1,n2 As Float";
_n1 = 0f;
_n2 = 0f;
 //BA.debugLineNum = 77;BA.debugLine="fs1=getinch(wdh)";
_fs1 = (float)(Double.parseDouble(_getinch(_ba,_wdh)));
 //BA.debugLineNum = 78;BA.debugLine="fs3=getinch(hgh)";
_fs3 = (float)(Double.parseDouble(_getinch(_ba,_hgh)));
 //BA.debugLineNum = 79;BA.debugLine="n1=fs1/szw";
_n1 = (float) (_fs1/(double)_szw);
 //BA.debugLineNum = 80;BA.debugLine="n2=fs3/szh";
_n2 = (float) (_fs3/(double)_szh);
 //BA.debugLineNum = 82;BA.debugLine="If n1>n2 Then";
if (_n1>_n2) { 
 //BA.debugLineNum = 83;BA.debugLine="fs2=n2*fs";
_fs2 = (float) (_n2*_fs);
 }else if(_n2>_n1) { 
 //BA.debugLineNum = 85;BA.debugLine="fs2=n1*fs";
_fs2 = (float) (_n1*_fs);
 }else if(_n1==_n2) { 
 //BA.debugLineNum = 87;BA.debugLine="fs2=n1*fs";
_fs2 = (float) (_n1*_fs);
 };
 //BA.debugLineNum = 90;BA.debugLine="Return fs2*1.5773684210526315789473684210526";
...
public static String  _getinch(anywheresoftware.b4a.BA _ba,float _px) throws Exception{
 //BA.debugLineNum = 67;BA.debugLine="Sub getinch(px As Float)";
 //BA.debugLineNum = 68;BA.debugLine="Dim h As Float";
_h = 0f;
 //BA.debugLineNum = 69;BA.debugLine="h=px/inc";
_h = (float) (_px/(double)_inc);
 //BA.debugLineNum = 70;BA.debugLine="Return h";
...
public static double  _getpastheight(anywheresoftware.b4a.BA _ba,float _px) throws Exception{
 //BA.debugLineNum = 113;BA.debugLine="Private Sub GetPastHeight(px As Float) As Double";
 //BA.debugLineNum = 115;BA.debugLine="Return (PastHeightScreen/getinch(HeightAct))*getin";
...
public static double  _getpastwidth(anywheresoftware.b4a.BA _ba,float _px) throws Exception{
 //BA.debugLineNum = 108;BA.debugLine="Private Sub GetPastWidth(px As Float) As Double";
 //BA.debugLineNum = 110;BA.debugLine="Return (PastWidthScreen/getinch(WidthAct))*getinch";
...
public static String  _setsize_img(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ImageViewWrapper _view,float _tv,float _lv,float _hv,float _wv,float _fontsize) throws Exception{
 //BA.debugLineNum = 59;BA.debugLine="Sub SetSize_img(View As ImageView,tv As Float,lv A";
...
public static String  _setsize_lbl_views(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.LabelWrapper _view,float _tv,float _lv,float _hv,float _wv,float _fontsize) throws Exception{
 //BA.debugLineNum = 54;BA.debugLine="Sub SetSize_lbl_Views(View As Label,tv As Float,lv";
 //BA.debugLineNum = 55;BA.debugLine="sizemode(View,tv,lv,hv,wv,WidthAct,HeightAct)";
_sizemode(_ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_view.getObject())),_tv,_lv,_hv,_wv,_widthact,_heightact);
 //BA.debugLineNum = 56;BA.debugLine="View.TextSize=fsz(View.Width,View.Height,GetPastWi";
_view.setTextSize((float) (_fsz(_ba,(float) (_view.getWidth()),(float) (_view.getHeight()),(float) (_getpastwidth(_ba,(float) (_view.getWidth()))),(float) (_getpastheight(_ba,(float) (_view.getHeight()))),(int) (_fontsize))));
...
public static String  _setsize_listview(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ListViewWrapper _view,float _tv,float _lv,float _hv,float _wv,float _fontsize) throws Exception{
 //BA.debugLineNum = 63;BA.debugLine="Sub SetSize_listview(View As ListView,tv As Float,";
...
public static String  _setsize_scrolview(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ScrollViewWrapper _view,float _tv,float _lv,float _hv,float _wv,float _fontsize) throws Exception{
 //BA.debugLineNum = 50;BA.debugLine="Sub SetSize_ScrolView(View As ScrollView,tv As Flo";
...
public static String  _setsize_txt(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.EditTextWrapper _view,float _tv,float _lv,float _hv,float _wv,float _fontsize) throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Sub SetSize_txt(View As EditText,tv As Float,lv As";
...
public static String  _setsizeviews(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _view,float _tv,float _lv,float _hv,float _wv,float _fontsize) throws Exception{
...
public static String  _sizemode(anywheresoftware.b4a.BA _ba,anywheresoftware.b4a.objects.ConcreteViewWrapper _view,float _tv,float _lv,float _hv,float _wv,float _xv,float _yv) throws Exception{
 //BA.debugLineNum = 95;BA.debugLine="Private Sub sizemode(View As View,tv As Float,lv A";
 //BA.debugLineNum = 96;BA.debugLine="View.Top=tv*(yv/DV_Height)";
_view.setTop((int) (_tv*(_yv/(double)_dv_height)));
 //BA.debugLineNum = 97;BA.debugLine="View.Left=lv*(xv/DV_Width)";
_view.setLeft((int) (_lv*(_xv/(double)_dv_width)));
 //BA.debugLineNum = 98;BA.debugLine="View.Width=wv*(xv/DV_Width)";
_view.setWidth((int) (_wv*(_xv/(double)_dv_width)));
 //BA.debugLineNum = 99;BA.debugLine="View.Height=hv*(yv/DV_Height)";
_view.setHeight((int) (_hv*(_yv/(double)_dv_height)));
 //BA.debugLineNum = 101;BA.debugLine="t=View.Top";
_t = (float) (_view.getTop());
 //BA.debugLineNum = 102;BA.debugLine="l=View.Left";
_l = (float) (_view.getLeft());
 //BA.debugLineNum = 103;BA.debugLine="w=View.Width";
_w = (float) (_view.getWidth());
 //BA.debugLineNum = 104;BA.debugLine="h=View.Height";
