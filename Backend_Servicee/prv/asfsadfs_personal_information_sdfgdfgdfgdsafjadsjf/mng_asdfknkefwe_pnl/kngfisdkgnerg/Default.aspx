<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="prv_asfsadfs_personal_information_sdfgdfgdfgdsafjadsjf_mng_asdfknkefwe_pnl_kngfisdkgnerg_Default" %>
...
<body>
    ...
    <div style="direction: ltr">
        ...
        <asp:TextBox ID="txt_groups" runat="server" CssClass="grd" Width="169px" 
            placeholder="کروه ها" Visible="False"></asp:TextBox>
        <br />
        <br />
    ...
    <p>
        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
            AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" CssClass="grd" 
            DataKeyNames="r" DataSourceID="SqlDataSource2" 
            EmptyDataText="There are no data records to display." 
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
            ...
            UpdateCommand="UPDATE [tbl_groups] SET [group_number] = @group_number, [user_number] = @user_number WHERE [r] = @r">
            <DeleteParameters>
                <asp:Parameter Name="r" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
    ...
    <p id="p_st" runat="server" style="color:Red;text-align:center;font-size:25px;">
        &nbsp;</p>
    <p runat="server" style="color:Red;text-align:center;font-size:25px;">
        &nbsp;</p>
    <p runat="server" style="color:Red;text-align:center;font-size:25px;">
        &nbsp;</p>
    <p runat="server" style="color:Red;text-align:center;font-size:25px;">
        &nbsp;</p>
    <p runat="server" style="color:Red;text-align:center;font-size:25px;">
        <asp:Button ID="btn_reset" runat="server" Height="18px" 
            onclick="btn_reset_Click" Text="eset" Width="23px" />
    </p>
    <p runat="server" style="color:Red;text-align:center;font-size:25px;">
        &nbsp;</p>
    </form>
